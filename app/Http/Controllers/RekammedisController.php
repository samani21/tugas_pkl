...
class RekammedisController extends Controller
{
    public function index(Request $request){
        ...
        $obat = DB::table('tb_obat')->paginate();
         return view('rekam_medis/dashboard/dashboard', ['pegawai' => $pegawai,'dokter' => $dokter,'perawat' => $perawat,'pasien' => $pasien,'berobat' => $berobat,'obat' => $obat,'obatmasuk' => $obatmasuk,'obatkeluar' => $obatkeluar,'title'=>'Dashboard'] );
    }
